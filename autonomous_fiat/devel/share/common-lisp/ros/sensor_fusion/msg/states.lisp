...
(cl:defmethod cl:initialize-instance :after ((m <states>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'states)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_fusion-msg:<states> is deprecated: use sensor_fusion-msg:states instead.")))

(cl:ensure-generic-function 'X-val :lambda-list '(m))
(cl:defmethod X-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:X-val is deprecated.  Use sensor_fusion-msg:X instead.")
  (X m))

(cl:ensure-generic-function 'Y-val :lambda-list '(m))
(cl:defmethod Y-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:Y-val is deprecated.  Use sensor_fusion-msg:Y instead.")
  (Y m))

(cl:ensure-generic-function 'Psi-val :lambda-list '(m))
(cl:defmethod Psi-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:Psi-val is deprecated.  Use sensor_fusion-msg:Psi instead.")
  (Psi m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:vx-val is deprecated.  Use sensor_fusion-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:vy-val is deprecated.  Use sensor_fusion-msg:vy instead.")
  (vy m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:r-val is deprecated.  Use sensor_fusion-msg:r instead.")
  (r m))
