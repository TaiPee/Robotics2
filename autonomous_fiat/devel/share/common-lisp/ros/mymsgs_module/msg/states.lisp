...
(cl:defmethod cl:initialize-instance :after ((m <states>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'states)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mymsgs_module-msg:<states> is deprecated: use mymsgs_module-msg:states instead.")))

(cl:ensure-generic-function 'X-val :lambda-list '(m))
(cl:defmethod X-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mymsgs_module-msg:X-val is deprecated.  Use mymsgs_module-msg:X instead.")
  (X m))

(cl:ensure-generic-function 'Y-val :lambda-list '(m))
(cl:defmethod Y-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mymsgs_module-msg:Y-val is deprecated.  Use mymsgs_module-msg:Y instead.")
  (Y m))

(cl:ensure-generic-function 'Psi-val :lambda-list '(m))
(cl:defmethod Psi-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mymsgs_module-msg:Psi-val is deprecated.  Use mymsgs_module-msg:Psi instead.")
  (Psi m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mymsgs_module-msg:vx-val is deprecated.  Use mymsgs_module-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mymsgs_module-msg:vy-val is deprecated.  Use mymsgs_module-msg:vy instead.")
  (vy m))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <states>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mymsgs_module-msg:r-val is deprecated.  Use mymsgs_module-msg:r instead.")
  (r m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<states>)))
  ...
  (cl:format cl:nil "float64 X         # X-coordinate position in the world        (m)~%float64 Y         # Y-coordinate position in the world        (m)~%float64 Psi       # yaw angle of the car in the world         (rad)~%float64 vx        # longitudinal velocity in x, local frame   (m/s)~%float64 vy        # lateral velocity in y, local frame        (m/s)~%float64 r         # yaw rate                                  (rad/s)~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'states)))
  "Returns full string definition for message of type 'states"
  (cl:format cl:nil "float64 X         # X-coordinate position in the world        (m)~%float64 Y         # Y-coordinate position in the world        (m)~%float64 Psi       # yaw angle of the car in the world         (rad)~%float64 vx        # longitudinal velocity in x, local frame   (m/s)~%float64 vy        # lateral velocity in y, local frame        (m/s)~%float64 r         # yaw rate                                  (rad/s)~%~%"))
